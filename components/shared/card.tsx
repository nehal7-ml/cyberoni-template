...
export const MainCard = ({
  ...
  return (
    <div className={`overflow-hidden z-50`}>
      <section className="p-4 antialiased text-gray-600">
        <div className="">
          <div className="mx-auto max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
            <div
              className={`overflow-hidden relative p-5 bg-indigo-700 rounded-lg shadow-lg ${width}`}
            >
              <svg
              ...
              <div className="relative pt-[6.25rem] pb-14">
                <div className="mb-2 text-xs font-bold tracking-widest text-green-400 uppercase">
                  {title}
                </div>
                <h3 className="mb-2 text-2xl font-extrabold leading-snug text-indigo-50">
                  {subtitle}
                </h3>
              ...
              <div className="flex flex-wrap justify-end">
                <div className="relative text-right">
                  <button
                    className={
                      "bg-purple-500 text-white hover:bg-cyan-600 active:bg-pink-600" +
                      "  ml-3 mb-3 rounded px-4 py-2 text-xs font-bold uppercase shadow outline-none ring ring-blue-300 hover:shadow-md hover:ring-cyan-500 focus:outline-none lg:mr-1 lg:mb-0"
                    }
                    type="button"
                ...
                <div className="text-right">
                  ...
                  <YoutubePopover width="850" height="500px" youtubeUrl="https://www.youtube.com/embed/erFZvwUhK-M" />
