import { getAll, read, remove, update } from "@/data/crud/event";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    if (req.method === "GET") {
        ...
        const event = await getAll( page,10, prisma)   // skipping 10 record for every new page
        res.status(200).json({ message: "found", data: event })
    }
    if (req.method === "POST") {
